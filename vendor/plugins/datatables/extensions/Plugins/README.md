...
Each directory has an index.html file which is used to generate the plug-ins documentation on [DataTables.net](https://datatables.net/plug-ins) and describes how plug-ins can be used.